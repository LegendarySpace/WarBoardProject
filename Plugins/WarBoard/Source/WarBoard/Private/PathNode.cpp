...
APathNode::APathNode()
{
	...
	// Import Materials
	auto m1 = ConstructorHelpers::FObjectFinder<UMaterialInstance>(TEXT("UMaterialInstance'/Plugins/WarBoard/WarBoard/Material/Node_Checked_MI.Node_Unchecked_MI"));
	if (m1.Object) M_Unchecked = m1.Object;
	auto m2 = ConstructorHelpers::FObjectFinder<UMaterialInstance>(TEXT("UMaterialInstance'/Plugins/WarBoard/WarBoard/Material/Node_Checked_MI.Node_Checked_MI"));
	if (m2.Object) M_Checked = m2.Object;
	auto m3 = ConstructorHelpers::FObjectFinder<UMaterialInstance>(TEXT("UMaterialInstance'/Plugins/WarBoard/WarBoard/Material/Node_Checked_MI.Node_Start_MI"));
	if (m3.Object) M_Start = m3.Object;
	auto m4 = ConstructorHelpers::FObjectFinder<UMaterialInstance>(TEXT("UMaterialInstance'/Plugins/WarBoard/WarBoard/Material/Node_Checked_MI.Node_End_MI"));
	if (m4.Object) M_End = m4.Object;
	auto m5 = ConstructorHelpers::FObjectFinder<UMaterialInstance>(TEXT("UMaterialInstance'/Plugins/WarBoard/WarBoard/Material/Node_Checked_MI.Node_Path_MI"));
	if (m5.Object) M_Path = m5.Object;
	auto m6 = ConstructorHelpers::FObjectFinder<UMaterialInstance>(TEXT("UMaterialInstance'/Plugins/WarBoard/WarBoard/Material/Node_Checked_MI.Node_Ignored_MI"));
